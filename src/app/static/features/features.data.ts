...
export const features: Feature[] = [
  {
    ...
    description: 'nep.features.angular',
  ...
  },
  {
    ...
    description: 'nep.features.angular-material',
  ...
  },
  {
    ...
    description: 'nep.features.angular-cli',
  ...
  },
  {
    ...
    description: 'nep.features.bootstrap',
  ...
  },
  {
    ...
    description: 'nep.features.typescript',
  ...
  },
  {
    ...
    description: 'nep.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'nep.features.fontawesome',
  ...
  },
  {
    ...
    description: 'nep.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'nep.features.themes.title',
    description: 'nep.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'nep.features.lazyloading.title',
    description: 'nep.features.lazyloading.description',
    documentation:
